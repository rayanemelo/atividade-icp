...
# gerar chave para crl
# openssl crl -in crl/raiz.crl.pem -noout -text
...
cd ..
cat ../web-server/certs/web.local.crt.pem certs/intermediaria.crt.pem ../raiz/certs/raiz.crt.pem > ../fullchain.pem
# verifique a cadeia:
openssl verify -CAfile ../raiz/certs/raiz.crt.pem -untrusted certs/intermediaria.crt.pem ../web-server/certs/web.local.crt.pem
# A saída esperada:
